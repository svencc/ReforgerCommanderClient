...
class RECOM_MapModule  : SCR_MapModuleBase {
	...
	void Render()	{		
		...
		foreach(RECOM_MapDrawCommandBase drawCommand : drawCommands) {
	...
	array<vector> generateRectangularPolygon(
		vector start, 
		vector end
	) {
	...
	array<vector> generateCircularPolygon(
		vector center, 
		float radius, 
		int resolution = 36
	) {
	...
	void renderLineCircledOutlined(
		vector center, 
		float radius, 
		float width, 
		int color, 
	...
	void renderLineRectangledOutlined(
		vector start,
		vector end, 
		float width, 
		int color, 
	...
	protected void renderGenericPolygon(
		array<vector> translatedPoints, 
		int color
	) {
	...
	protected void renderGenericPolygonToLines(
		array<vector> translatedPoints, 
		float width, 
		int color
	) {
	...
	protected void renderGenericPolygonToLinesOutlined(
		array<vector> translatedPoints, 
		float width, 
		int color, 
		float widthOutline, 
	...
	protected void renderRawLineOutlined(
		vector start, 
		vector end, 
		float width, 
		int color, 
